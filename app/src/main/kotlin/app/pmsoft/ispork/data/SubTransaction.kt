...
@Entity(
  ...
  indices = [Index("transaction_definition_id"), Index("participant_id")]
)
@Parcelize
open class SubTransaction(
  ...
  @ColumnInfo(name = "booked_currency")
  open var bookedCurrency: Currency?,
...
class FullSubTransaction(
  ...
  @Ignore
  override var bookedCurrency: Currency?,

  /** This field is not filled as the link is made through [FullTransactionDefinition.subTransactions]. */
  @Ignore
